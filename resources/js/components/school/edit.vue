                    ...
                    <v-layout row wrap>
                        <v-flex sm12>
                            <div>
                                ...
                                <el-input placeholder="Name" v-model="form.schoolName"></el-input>
                            </div>
                            <div>
                                <label for="">Level</label>
                                <el-input placeholder="Name" v-model="form.levelId"></el-input>
                            </div>
                            ...
                            <el-select v-model="form.wardId" filterable clearable placeholder="Ward" style="width: 100%;">
